...
class CommonArgs(Tap):
    ...
    model: Literal['dmpnn', 'mlptrigonometric','kantrigonometric'] = 'mlptrigonometric'
    "the types of model"
...
class TrainArgs(CommonArgs):
    ...
    loss_function: Literal[
        'mse', 'bounded_mse', 'binary_cross_entropy', 'cross_entropy', 'mcc', 'sid', 'wasserstein', 'mve', 'evidential', 'dirichlet', 'quantile_interval'] = None
        ...
        for metric in self.metrics:
            if not any([(self.dataset_type == 'classification' and metric in ['auc', 'prc-auc', 'accuracy',
                        ...
                        (self.dataset_type == 'regression' and metric in ['rmse', 'mae', 'mse', 'r2', 'bounded_rmse',
                                                                          'bounded_mae', 'bounded_mse', 'quantile']),
